...
public class FighterServiceImpl implements FighterService {
  ...
  public static final String SELECTOR_FIGHTER_WINS_METHODS_ELEMENTS =
      ".bio_graph:first-of-type .graph_tag";
  ...
  public FighterDto parse(final String url) throws IOException, ParseException, ParserException {
    ...
    // loses
    extractIntProperty(
        url, doc, SELECTOR_FIGHTER_LOSSES_ELEMENTS, "lossesTotals", builder::lossesTotals);
  ...
  private void extractIntProperty(
      String url, Document doc, String selector, String property, IntConsumer setter) {
    try {
   ...
   */
  private List<FightDto> parseFights(Elements tableRows, FighterDto fighter)
  ...
  public void extractAndSetText(
      Document doc, String selector, String propertyName, Consumer<String> setter) {
