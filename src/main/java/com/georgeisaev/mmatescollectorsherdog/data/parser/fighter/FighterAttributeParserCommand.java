...
public enum FighterAttributeParserCommand
  ...
  // height
  HEIGHT_FT("heightFt", ".fighter-data .bio-holder tr:nth-child(2) td:nth-child(2) b[itemprop=\"height\"]"),
  HEIGHT_CM("heightCm", ".fighter-data .bio-holder tr:nth-child(2) td:nth-child(2)"),
  // weight
  WEIGHT_KG("weightKg", ".fighter-data .bio-holder tr:nth-child(2) td:nth-child(2) b[itemprop=\"height\"]"),
